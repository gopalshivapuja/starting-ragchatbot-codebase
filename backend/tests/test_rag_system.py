...
class TestRAGSystemContentQueries:
    ...
    def test_content_query_complete_flow(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_ai_instance.generate_response = Mock(return_value="Lesson 5 covers MCP client creation.")
        ...
        rag.tool_manager.get_last_sources = Mock(return_value=[
            {"text": "MCP Course - Lesson 5", "link": "https://example.com/lesson/5"}
        ])
        rag.tool_manager.reset_sources = Mock()

        # Execute query
        response, sources = rag.query("What is covered in lesson 5 of MCP course?", session_id="test_session")
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_outline_query_flow(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
        """Test outline query flow."""
        mock_vs_instance = Mock()
        mock_vector_store.return_value = mock_vs_instance

        mock_ai_instance = Mock()
        mock_ai_instance.generate_response = Mock(return_value="Course outline: Lesson 0, Lesson 1, Lesson 5")
        mock_ai_gen.return_value = mock_ai_instance
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_general_query_without_tools(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
        """Test general knowledge query that doesn't need tools."""
        mock_vs_instance = Mock()
        mock_vector_store.return_value = mock_vs_instance

        mock_ai_instance = Mock()
        mock_ai_instance.generate_response = Mock(return_value="RAG is Retrieval-Augmented Generation.")
        mock_ai_gen.return_value = mock_ai_instance
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_session_management(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
        ...
        mock_sm_instance.get_conversation_history.assert_called_once_with("test_session")
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_source_reset_after_retrieval(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_error_handling_in_query(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_tools_registered_on_initialization(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
    ...
    @patch('rag_system.SessionManager')
    @patch('rag_system.DocumentProcessor')
    def test_empty_query_handling(self, mock_doc_proc, mock_session_mgr, mock_vector_store, mock_ai_gen, mock_config):
        """Test handling of empty queries."""
        mock_vs_instance = Mock()
        mock_vector_store.return_value = mock_vs_instance

        mock_ai_instance = Mock()
        mock_ai_instance.generate_response = Mock(return_value="Please provide a question.")
        mock_ai_gen.return_value = mock_ai_instance
