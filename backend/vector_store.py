...
class VectorStore:
    ...
    def get_course_outline(self, course_name: str) -> Optional[Dict[str, Any]]:
        ...
        Uses fuzzy matching via vector search to find the course.

        Args:
            course_name: Course name (can be partial or fuzzy)
        ...
        try:
            # Get course metadata by exact title (which is the ID)
